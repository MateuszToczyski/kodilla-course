...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        double averageDuration = inProgressList.stream()
                .mapToDouble(task -> (double) Period.between(task.getCreated(), LocalDate.now()).getDays())
                .average()
                .orElseThrow(IllegalArgumentException::new);

        Assert.assertEquals(10.0, averageDuration, 0.001);
